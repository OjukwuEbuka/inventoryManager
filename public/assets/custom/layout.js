...
$(document).ready(function () {
    ...
    const validateFormAndSubmit = (actionURL, form, operationType) => {
        ...
        const successResFxn = res => {
            ...
            const staffRes = `
                <div class="col m4">
                    <img src="/storage/images/passports/${res.img}" />
                </div>
            ...
            `;            
            let profileLink = res.model == 'staff' ? `/staff/${res.id}/details` : `/${school_id}/student/${res.id}`;
